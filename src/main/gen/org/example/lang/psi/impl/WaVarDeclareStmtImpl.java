...
public class WaVarDeclareStmtImpl extends ASTWrapperPsiElement implements WaVarDeclareStmt {

  public WaVarDeclareStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WaVisitor visitor) {
    visitor.visitVarDeclareStmt(this);
  }
  ...
  public WaExpr getExpr() {
    return findChildByClass(WaExpr.class);
  }
