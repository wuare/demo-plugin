...
public class WaIfStmtImpl extends ASTWrapperPsiElement implements WaIfStmt {

  public WaIfStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WaBlock> getBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WaBlock.class);
  }
